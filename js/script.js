$(document).ready(function() {
    $('.about-inner__more').click(function() {
        $('.about-inner__text-hide').addClass('active');
        $('.about-inner__more').addClass('hide');
    });
    $('.about-inner__less').click(function() {
        $('.about-inner__text-hide').removeClass('active');
        $('.about-inner__more').removeClass('hide');
    });

    $('.program__inner-more').click(function() {
        $('.program__inner-plus').addClass('active');
        $('.program__inner-more').addClass('hide');
    });

    $('.item-program__plus').click(function() {
        this.parentElement.classList.add("active");
        this.classList.add("hide")
    });

    $(".header__bottom, .bonuses__btn").on("click", "a", function(event) {
...
if ($('.slider__inner-2').length > 0) {
    $('.slider__inner-2').slick({
        ...
        //appendDots:
        //appendArrows:$('.mainslider-arrows .container'),
        nextArrow: $('.slider__arrow-next-2'),
        prevArrow: $('.slider__arrow-prev-2'),
        responsive: [{
            breakpoint: 768,
            settings: {
                slidesToShow: 1
